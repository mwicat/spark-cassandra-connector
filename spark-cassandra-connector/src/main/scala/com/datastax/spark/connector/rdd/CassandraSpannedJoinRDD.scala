 ...
 */
class CassandraSpannedJoinRDD[K,L,R] private[connector](
    left: RDD[(K, L)],
  ...
  override type Self = CassandraSpannedJoinRDD[K, L, R]
  ...
  override protected def copy(
    ...
    new CassandraSpannedJoinRDD[K,L,R](
      left = left,
   ...
   */
  private[connector] def applyToRDD( left:RDD[(K, L)]): CassandraSpannedJoinRDD[K,L,R] =  {
    new CassandraSpannedJoinRDD[K,L,R](
      left,
      keyspaceName,
      tableName,
